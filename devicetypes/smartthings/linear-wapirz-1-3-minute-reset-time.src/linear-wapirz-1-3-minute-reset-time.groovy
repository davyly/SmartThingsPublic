metadata {
	...
	definition (name: "Linear WAPIRZ-1 (3 Minute Reset Time)", namespace: "smartthings", author: "SmartThings") {
...
def configure() {
	...
	//send no-motion report 3 minutes after motion stops
	zwave.configurationV1.configurationSet(parameterNumber: 1, size: 2, scaledConfigurationValue: 3).format()
}